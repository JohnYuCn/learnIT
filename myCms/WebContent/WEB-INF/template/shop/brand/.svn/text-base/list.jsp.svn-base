...
<div class="tableDiv">
						...
						<div class="panel panel-default form-horizontal form-border">
						 ...
						 <div class="panel panel-default">
							...
							<table class="table table-striped table-bordered" cellspacing="0" width="100%">
								...
								<tbody>
									<c:forEach var="bra" items="${paging.object}" >
									<tr>
										...
										<td>${bra.addDate }</td>
										<td><a href="<%=path%>/shop/brand/toAddOrUpdate?braID=${bra.braID}">修改</a> &nbsp&nbsp <a href="<%=path%>/shop/brand/delete?braID=${bra.braID}">删除</a> </td>
									</tr>
									</c:forEach>
								</tbody>	
								<tr>
							...
							<form action="<%=path %>/shop/brand/list" id="s_form" method="post">
								<!-- 查询条件所需 -->
		...
		$(function(){
			...
			$("#submit").click(function(){
				...
				//$("#s_form").submit();
				clickMenu('/shop/brand/list','s_form');
