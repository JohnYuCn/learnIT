...
function(a, b) {
	...
	h.pt = h.prototype, h.pt.config = {
		...
		c = jQuery, d = c(a), g.html = c("html"), layer.use("../assets/ins/js/layer/skin/layer.css"), c.layer = function(a) {
			var b = new h(a);
			return b.index
		}, (new Image).src = layer.path + "../assets/ins/js/layer/skin/default/xubox_ico0.png"
